    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">환경설정 / 서비스 이용약관</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <div class="summernote" id="terms">{!! $setting->terms !!}</div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(function() {
            ...
            $("body").on("click", "#button_save", function(e) {
                e.preventDefault();
                var terms = $("#terms").next().find('.note-editable').html();

                $.ajax({
                    type: "POST",
                    url: "/admin/setting/terms/update",
                    data: {
                        _token: CSRF_TOKEN,
                        terms: terms
                    },
